...
void draw()
{
  ...
  //noStroke();
  for (int i = 0; i<6; i++) {
    line(205+i*(width-205)/6, 0, 205+i*(width-205)/6, 40);
    if (i==0) {
      text("Watercolor", 205+i*(width-205)/6+(width-205)/12, 20);
    }
    if (i==1) {
      text("Edges", 205+i*(width-205)/6+(width-205)/12, 20);
    }
    if (i==2) {
      text("Pixelated Noise", 205+i*(width-205)/6+(width-205)/12, 20);
    }
    if (i==3) {
      text("Ellipse", 205+i*(width-205)/6+(width-205)/12, 20);
    }
    if (i==4) {
      text("Rectangle", 205+i*(width-205)/6+(width-205)/12, 20);
    }
    if (i==5) {
      text("Brush", 205+i*(width-205)/6+(width-205)/12, 20);
    }
  }
  if (DropDown) {
...
void mouseClicked() {
  ...
  if ((abs(102-mouseX )<=100)&&(abs((20)-mouseY)<=20)) { //Load Image
    ...
    if ((abs(((205+0*(width-205)/6)-mouseX ))<=(width-205)/12)&&(abs((20)-mouseY)<=20)) { //Load Image
    WaterColor = true;
    }
    if ((abs((205+1*(width-205)/6-mouseX ))<=(width-205)/12)&&(abs((20)-mouseY)<=20)) { //Load Image
    Edges = true;
    }
    if ((abs((205+2*(width-205)/6-mouseX ))<=(width-205)/12)&&(abs((20)-mouseY)<=20)) { //Load Image
    PixelatedNoise = true;
    }
    if ((abs((205+3*(width-205)/6-mouseX ))<=(width-205)/12)&&(abs((20)-mouseY)<=20)) { //Load Image
    Ellipse = !Ellipse;
    }
    if ((abs((205+4*(width-205)/6-mouseX ))<=(width-205)/12)&&(abs((20)-mouseY)<=20)) { //Load Image
    Rect = !Rect;
    println("Rect");
    }
    if ((abs((205+5*(width-205)/6-mouseX ))<=(width-205)/12)&&(abs((20)-mouseY)<=20)) { //Load Image
    Brush = !Brush;
    println("Brush!");
    }
